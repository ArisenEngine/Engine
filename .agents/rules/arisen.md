...
- For platform/RHI/rendering work, verify the current editor/runtime policy in `AGENTS.md`, `Rendering.md`, and `RuntimeRenderingNextTodo.md` before changing code.
