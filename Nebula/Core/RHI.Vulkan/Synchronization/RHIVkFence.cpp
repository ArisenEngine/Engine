...
NebulaEngine::RHI::RHIVkFence::RHIVkFence(VkDevice device) : RHIFence(), m_VkDevice(device)
{
...
NebulaEngine::RHI::RHIVkFence::~RHIVkFence() noexcept
{
...
void NebulaEngine::RHI::RHIVkFence::Lock()
{
    vkWaitForFences(m_VkDevice, 1, &m_VkFence, VK_TRUE, UINT64_MAX);
}

void NebulaEngine::RHI::RHIVkFence::Unlock()
{
