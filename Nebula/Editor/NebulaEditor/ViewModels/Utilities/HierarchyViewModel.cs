...
using NebulaEditor.Models.Utilities;
using NebulaEngine;

namespace NebulaEditor.ViewModels.Utilities;

public class HierarchyViewModel : ViewModelBase
{
    private static IconConverter? s_iconConverter;
    
    public HierarchicalTreeDataGridSource<TreeNodeBase> Source { get; private set; }
    ...
    public static IMultiValueConverter IconConverter
    {
        ...
        get{
            if (s_iconConverter is null)
            {
                ...
                using (var folderOpenStream = AssetLoader.Open(new Uri("avares://NebulaEditor/Assets/Icons/open-folder.png")))
                {
    ...
    public HierarchyViewModel(string leafIconPath, string branchIconPath, string branchOpenIconPath)
    {
        Initialize();
    }
    ...
    {
        Source = new HierarchicalTreeDataGridSource<TreeNodeBase>(Array.Empty<TreeNodeBase>())
        {
            Columns =
            {
