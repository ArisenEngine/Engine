...
if exist "%SLN_PATH%" (
    ...
    for %%I in ("!SCRIPT_DIR!\..\..\..\Test\ArisenEngineTest\ArisenEngineTest.csproj") do set "ARISEN_ENGINE_TEST=%%~fI"
    ...
    if not exist "!ARISEN_ENGINE_TEST!" (
        echo ERROR: Missing project ^(ArisenEngineTest^) at !SCRIPT_DIR!\..\..\..\Test\ArisenEngineTest\ArisenEngineTest.csproj
        set "EXIT_CODE=1"
        goto :cleanup
    )
    ...
    set "REL_ARISEN_ENGINE_TEST=..\..\..\Test\ArisenEngineTest\ArisenEngineTest.csproj"
