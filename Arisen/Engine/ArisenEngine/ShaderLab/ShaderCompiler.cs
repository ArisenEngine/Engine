...
namespace ArisenEngine.ShaderLab
{
    public static class ShaderCompiler
    {
            ...
            CompileOptions options)
        {
            unsafe
            {
                ...
                try
                {
                    ...
                    {
                        ok = ArisenBinding.NativePlatform.ArisenEngine.Platforms.ShaderCompilerAPI.CompileShaderFromFileSimple(
                            inputPath,
                            stage,
                            options.Entry ?? "main",
        ...
        private static void EnsureDxcInitialized()
        {
            ...
            ArisenBinding.NativePlatform.ArisenEngine.Platforms.ShaderCompilerAPI.InitDXC();
        ...
        {
            if (!s_DxcInitialized) return;
            ArisenBinding.NativePlatform.ArisenEngine.Platforms.ShaderCompilerAPI.ReleaseDXC();
