...
#include "../../Core/Core.Infra/RHI/Instance.h"
...
extern "C" ENGINE_DLL RHI_InstanceHandle RHI_CreateInstance(const ArisenEngine::RHI::InstanceInfo* info);
...
extern "C" ENGINE_DLL bool RHI_Instance_PresentModeSupported(RHI_InstanceHandle instance, unsigned int windowId, ArisenEngine::RHI::PresentMode mode);
extern "C" ENGINE_DLL void RHI_Instance_SetCurrentPresentMode(RHI_InstanceHandle instance, unsigned int windowId, ArisenEngine::RHI::PresentMode mode);
...
extern "C" ENGINE_DLL ArisenEngine::RHI::PresentMode RHI_Instance_GetSuitablePresentMode(RHI_InstanceHandle instance, unsigned int windowId);
