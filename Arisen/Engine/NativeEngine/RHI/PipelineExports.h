...
extern "C" ENGINE_DLL void RHI_PSO_AddDescriptorSetLayoutBinding_Buffers(RHI_PSOHandle pso, unsigned int layoutIndex, unsigned int binding, ArisenEngine::RHI::EDescriptorType type, unsigned int descriptorCount, unsigned int shaderStageFlags, ArisenEngine::Containers::Vector<std::shared_ptr<ArisenEngine::RHI::BufferHandle>>* buffers);
extern "C" ENGINE_DLL void RHI_PSO_UpdateDescriptorSet_Buffers(RHI_PSOHandle pso, unsigned int layoutIndex, unsigned int binding, ArisenEngine::Containers::Vector<std::shared_ptr<ArisenEngine::RHI::BufferHandle>>* buffers);
...
extern "C" ENGINE_DLL void RHI_RenderPass_AddAttachmentAction(RHI_RenderPassHandle rp, ArisenEngine::RHI::EFormat format, ArisenEngine::RHI::ESampleCountFlagBits samples, ArisenEngine::RHI::AttachmentLoadOp colorLoad, ArisenEngine::RHI::AttachmentStoreOp colorStore, ArisenEngine::RHI::AttachmentLoadOp stencilLoad, ArisenEngine::RHI::AttachmentStoreOp stencilStore, ArisenEngine::RHI::EImageLayout initialLayout, ArisenEngine::RHI::EImageLayout finalLayout);
