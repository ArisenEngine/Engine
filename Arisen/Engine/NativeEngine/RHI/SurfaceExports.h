...
extern "C" ENGINE_DLL void RHI_FrameBuffer_SetAttachment(RHI_FrameBufferHandle fb, unsigned int frameIndex, ArisenEngine::RHI::ImageView* view, RHI_RenderPassHandle rp);
