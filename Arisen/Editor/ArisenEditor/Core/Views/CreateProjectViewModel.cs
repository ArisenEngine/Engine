...
namespace ArisenEditor.ViewModels.Startup
{
    public class CreateProjectViewModel : StartupSubViewBaseViewModel
    {
        ...
        public ICommand? BrowerProjectLocationCommand { get; }
        public ICommand? CreateProjectCommand { get; }

        public CreateProjectViewModel(): base()
        {
            BrowerProjectLocationCommand = ReactiveCommand.Create(async () =>
            {
                var pathList = await FileSystemUtilities.BrowserDirectory("Select your project location");
            ...
            CreateProjectCommand = ReactiveCommand.Create(this.CreateProject, outputScheduler: AvaloniaScheduler.Instance);
        }
