...
{
    public class StartupWindowViewModel : ReactiveObject
    {
        ...
        public StartupWindowViewModel()
        {
            ...
            SelectionChangedCommand = ReactiveCommand.Create(OnTabControlSelectionChanged, outputScheduler: AvaloniaScheduler.Instance);
        }
        ...
        internal async Task<int> LoadEditorConfigAsync()
        {
            ...
            catch(Exception ex)
            {
                ...
                await MessageBoxUtility.ShowMessageBoxStandard("Exception", $"{ex.StackTrace}\n{ex.Message}");
