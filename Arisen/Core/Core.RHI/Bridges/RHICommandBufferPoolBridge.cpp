...
RHI_DLL void RHICommandBufferPool_GetCommandBuffer(RHICommandBufferPool* pool, uint32_t currentFrameIndex, int level, uint32_t* outIndex, uint32_t* outGeneration)
{
...
RHI_DLL void RHICommandBufferPool_ReleaseCommandBuffer(RHICommandBufferPool* pool, uint32_t currentFrameIndex, uint32_t index, uint32_t generation)
{
