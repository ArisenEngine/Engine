...
{
    ARISEN_BIND_ENUM(EBufferUsageFlagBits)
    typedef enum EBufferUsageFlagBits {
        ...
        BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT = BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR,
        BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR = 0x00100000,
        BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT = BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR,
