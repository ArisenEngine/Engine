...
namespace ArisenEngine::HAL
{
    extern "C"
    {
        ...
        HAL_DLL UInt32 CreateRenderWindowWithResizeCallback(WindowHandle host, WindowProc callback,  WindowExitResize resizeCallback, WindowResize resizingCallback, SInt32 width, SInt32 height);
