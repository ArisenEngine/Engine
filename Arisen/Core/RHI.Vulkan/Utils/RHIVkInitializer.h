...
namespace ArisenEngine::RHI
{
    ...
    inline VkPipelineStageFlags2KHR MapPipelineStageFlags2(EPipelineStageFlag flags)
    {
        ...
        if (flags & PIPELINE_STAGE_TASK_SHADER_BIT_EXT) flags2 |= VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_KHR;
        if (flags & PIPELINE_STAGE_MESH_SHADER_BIT_EXT) flags2 |= VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_KHR;
