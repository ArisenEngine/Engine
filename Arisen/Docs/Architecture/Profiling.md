...
- Generated Development profile projects define `ARISEN_PROFILER_ENABLED`.
- Generated Production profile projects do not define profiler instrumentation.
- The regular Arisen build links the Tracy client, but it does not build the Tracy Profiler viewer executable.

## Timeline Workflow

1. Build and run the Development profile.
...
- launch PackageGame/editor with a profiler-friendly Development profile;
