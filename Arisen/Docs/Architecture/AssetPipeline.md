...
- `com.arisen.vegetation`: `VegetationSpecies`, including each LOD's exact mesh/material dependencies; and `VegetationBiome`, including every referenced vegetation species.
...
This slice does not define vegetation scatter output, generated cluster identity, cluster or instance-page containers, scene codecs, residency, rendering, Editor authoring, or backend behavior. Those remain later vegetation milestones.
